 ...
 */
export const getPortfolio = async ( options?: Parameters<typeof customFetch>[1]): Promise<PortfolioSnapshot> => {
...
export const getGetPortfolioProjectUrl = (projectId: string,) => {




  return `/api/portfolio/projects/${projectId}`
}

/**
 * @summary Load one project from the founder portfolio
 */
export const getPortfolioProject = async (projectId: string, options?: Parameters<typeof customFetch>[1]): Promise<Project> => {

  return customFetch<Project>(getGetPortfolioProjectUrl(projectId),
  {
    ...options,
    method: 'GET'
...
export const getGetPortfolioProjectQueryKey = (projectId: string,) => {
    return [
...
export const getGetPortfolioProjectQueryOptions = <TData = Awaited<ReturnType<typeof getPortfolioProject>>, TError = ErrorType<ErrorResponse>>(projectId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPortfolioProject>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetPortfolioProjectQueryKey(projectId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPortfolioProject>>> = ({ signal }) => getPortfolioProject(projectId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: projectId !== null && projectId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPortfolioProject>>, TError, TData> & { queryKey: QueryKey }
}

export type GetPortfolioProjectQueryResult = NonNullable<Awaited<ReturnType<typeof getPortfolioProject>>>
export type GetPortfolioProjectQueryError = ErrorType<ErrorResponse>
...
export function useGetPortfolioProject<TData = Awaited<ReturnType<typeof getPortfolioProject>>, TError = ErrorType<ErrorResponse>>(
 projectId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getPortfolioProject>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetPortfolioProjectQueryOptions(projectId,options)
